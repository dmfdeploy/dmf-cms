...
echo "       cd $CMS_HINT"
echo "       gh auth token | GHCR_USER='<github-username>' scripts/publish-to-ghcr.sh"
echo "       # needs write:packages — 'gh auth status' to check,"
echo "       # 'gh auth refresh -s write:packages' if absent."
